...
function (_React$Component) {
  ...
  _createClass(DateTimeRangePicker, [{
    ...
    value: function componentDidMount() {
      ...
      var values = Object.values(ranges);
      var crIndex = values.findIndex(function (i) {
    ...
    value: function render() {
      return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_Ranges.default, {
        ranges: this.state.ranges,
        selectedRange: this.state.selectedRange,
        rangeSelectedCallback: this.rangeSelectedCallback,
        screenWidthToTheRight: this.props.screenWidthToTheRight
      }), this.state.showCalendars && _react.default.createElement("div", {
        className: "simple-calendar-start-end"
