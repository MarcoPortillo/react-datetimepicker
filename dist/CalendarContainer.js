...
function (_React$Component) {
  ...
  function CalendarContainer(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(CalendarContainer).call(this, props));
    _this.state = {
      visible: false,
      x: 0,
      y: 0,
  ...
  _createClass(CalendarContainer, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        keyboardCellCallback: function keyboardCellCallback(data) {
          return console.log('keyboardCellCallback', data);
        },
        focusOnCallback: function focusOnCallback(data) {
          console.log('focusOnCallback', data);
        },
        focusDate: false,
        cellFocusedCallback: function cellFocusedCallback(data) {
          /*console.log('cellFocusedCallback', data) */
        },
...
CalendarContainer.propTypes = {
  value: _reactMomentProptypes.default.momentObj,
